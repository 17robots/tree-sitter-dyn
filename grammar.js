...
module.exports = grammar({
  ...
  conflicts: $ => [
    ...
    [$.var_decl, $.enum_member],
    [$.var_decl, $.enum_param],
    [$.var_decl, $.error_member],
    [$.var_decl, $.error_param],
    [$.var_decl, $.struct_member],
    [$.var_decl, $.struct_param],
    [$.struct_initializer, $.member_chain],
  ],
  rules: {
    ...
    label: $ => prec(2, seq($.identifier, ':', $.block)),
    arrow_expr: $ => seq('=>', $.expr, ';'),
    ...
    suffix: $ => prec(2, choice($.suffix_no_call, $.fn_call_suffix)),
    ...
    digit: $ => /[0-9]/,
    type_expr: $ => choice($.array_type, $.pointer_type, $.optional_type, $.member_chain, $.identifier),
