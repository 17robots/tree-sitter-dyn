...
module.exports = grammar({
  ...
  rules: {
    ...
    declaration: $ => choice($.use, $.const_variable, $.thread_local_variable, $.struct, $.enum, $.fn, $.type_alias),
    ...
    statement: $ => choice($.return_, $.continue_, $.break_, $.variable, $.thread_local_variable, $.const_variable, $.if_, $.case_, $.for_, $.defer, $.expression, $.assignment, $.panic, $.syscall, $.type_alias),
    ...
    struct_literal: $ => seq(choice(seq($.identifier, repeat(seq('.', $.identifier))), '.'), optional(seq('(', commaSep($.type), ')')), '{', commaSep($.struct_literal_member), '}'),
