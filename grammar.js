...
module.exports = grammar({
  ...
  rules: {
    ...
    function_declaration: $ => seq(optional('inline'), '(', comma_separated($.parameter), ')', optional(choice($.type, $.actionable_expression)), optional($.error_suffix), choice($.block, seq('=>', $.expression))),
    ...
    function_type: $ => seq('(', comma_separated(choice($.expression, seq('comp', 'type'))), ')', optional(choice($.actionable_expression, $.type)), optional($.error_suffix)),
